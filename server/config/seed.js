...
Thing.find({}).remove()
  .then(() => {
    Thing.create({
      ...
      info: 'Integration with popular tools such as Webpack, Gulp, Babel,'
        + 'TypeScript, Karma, Mocha, ESLint, Node Inspector, Livereload,'
        + ' Protractor, Pug, Stylus, Sass, and Less.'
    }, {
